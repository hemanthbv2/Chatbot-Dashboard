/**
 * RVGHS Telemetry Engine - Dual Write Architecture
 *
...
(function () {
    ...
    function getEndpoints() {
        const wpRestUrl   = (window.rvghsChatbotSettings && window.rvghsChatbotSettings.restUrl)
                            ? window.rvghsChatbotSettings.restUrl.replace(/\/$/, '')   // e.g. https://rvghs.edu.in/wp-json/rvghs/v1
                            : '';
        const vercelUrl   = (window.rvghsChatbotSettings && window.rvghsChatbotSettings.vercelUrl)
                            ? window.rvghsChatbotSettings.vercelUrl.replace(/\/$/, '') // e.g. https://rvghs-api.vercel.app
                            : '';
